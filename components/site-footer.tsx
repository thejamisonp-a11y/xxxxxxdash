        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Premium companions, available 24/7.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              <li><Link href="/browse" className="text-slate-400 hover:text-white transition-colors">Browse</Link></li>
              <li><Link href="/safety" className="text-slate-400 hover:text-white transition-colors">Safety</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li><Link href="/investors" className="text-slate-400 hover:text-white transition-colors">Investors</Link></li>
            </ul>
          </div>
        </div>
